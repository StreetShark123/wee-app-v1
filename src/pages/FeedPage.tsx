...
// "Club": la vida del club como feed navegable (solo lectura). Cada señal
// muestra su CONTENIDO (el comentario, la nota, la propuesta) y al tocarla
// salta al libro/comentario — la conversación sigue anclada al libro.
  ...
  return (
    <main>
      <div className="feed-page">
        ...
        <p className="hint feed-intro">{pick(language, "Lo que se mueve en las últimas 24 horas. Toca una señal para ir al libro.", "What's moving in the last 24 hours. Tap a signal to jump to the book.", "O que se move nas últimas 24 horas. Toca un sinal para ir ao libro.")}</p>
