...
// Ajustes: quién eres (perfil) + todo lo que NO es "qué lees" (eso vive en
// Tú, que es solo biblioteca personal). Perfil, notificaciones, accesibilidad,
// datos/privacidad, el club y la sesión.
